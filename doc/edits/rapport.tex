...
\begin{figure}[H]
	...
	\begin{ganttchart}[vgrid, hgrid, y unit title=1cm, y unit chart=0.7cm, x unit=0.8cm]{1}{14}
	    ...
	    \ganttbar[bar/.append style={fill=red}]{Code backbone}{7}{11} \ganttnewline
	    \ganttbar[bar/.append style={fill=red}]{Code essentiel}{0}{0} \ganttnewline
	    \ganttbar[bar/.append style={fill=blue}]{Poster}{0}{0} \ganttnewline
	    \ganttbar[bar/.append style={fill=blue}]{Documentation}{1}{8} \ganttnewline
	    \ganttmilestone{Rendu inter. doc. + poster}{14}
	\end{ganttchart}
