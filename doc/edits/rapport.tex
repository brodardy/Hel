...
\begin{titlepage}
	\begin{center}
		...
		\textsc{\Large Centre de formation professionnelle technique}\\[.4cm]
...
\paragraph{Points de compétences}
...
\subsection{Estimation du budget}
Sans compter l'amortissement de l'ordinateur, le budget se traduit par :

\texttt{
\begin{description}
	\item Développeur : 200 CHF par heure
	\item Temps total : 256 heures distribuées dans 7 semaines
	\item
	\item Coût total en CHF : $200*256=51200$ CHF
\end{description}
}

\subsection{Livrables}
\begin{itemize}
	\item 1 journal de bord (cahier A5)
	\item 1 poster A2
	...
	\begin{itemize}
		\item \emph{live CD, live USB}
		\item machine virtuelle (\emph{VirtualBox}) pré-configurée
		\item téléphone/tablette pré-installé
	\end{itemize}
\end{itemize}
...
\begin{figure}[htp]
	...
	\begin{ganttchart}[vgrid, hgrid, y unit title=1cm, y unit chart=0.7cm, x unit=0.8cm]{1}{14}
	    ...
	    \ganttbar[bar/.append style={fill=green}]{Contenus}{8}{14} \ganttnewline
...
\begin{figure}[htp]
	...
	\begin{ganttchart}[vgrid, hgrid, y unit title=1cm, y unit chart=0.7cm, x unit=0.8cm]{1}{6}
	    ...
	    \ganttbar[bar/.append style={fill=green}]{Contenus}{1}{1} \ganttnewline
